...
enum AppAction {
    ...
    case fetchMPVKeys(gid: String, pageNumber: Int, mpvURL: String)
    case fetchMPVKeysDone(gid: String, pageNumber: Int, result: Result<(String, [Int: String]), AppError>)
    case fetchThumbnailURLs(gid: String, index: Int)
    case fetchThumbnailURLsDone(gid: String, pageNumber: Int, result: Result<[(Int, URL)], AppError>)
    case fetchGalleryNormalContents(gid: String, pageNumber: Int, thumbnailURLs: [(Int, URL)])
    case fetchGalleryNormalContentsDone(gid: String, pageNumber: Int, result: Result<[Int: String], AppError>)
