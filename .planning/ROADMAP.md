...
- [ ] 01-01-PLAN.md — Wave 0 conversion/color fixture lock and simulator validation
- [ ] 01-02-PLAN.md — Wave 0 markdown/domain-fronting fixture lock

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 01-03-PLAN.md — Local SwiftyOpenCC module and FileClient adoption

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 01-04-PLAN.md — Local UIImageColors module and LibraryClient adoption
...
- [ ] 01-07-PLAN.md — Colorful update and GalleryCardCell gradient parity
...
|-------|----------------|--------|-----------|
| 1. Isolated Dependency Modernization | 0/7 | Not started | - |
