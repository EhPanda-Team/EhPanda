...
| Search root (#W-22) | v3b changes the `SuggestionsPanel` intrinsic-height floor, title identity and search layout; this is a rendered-layout change and requires a fresh D-25 re-sweep | XXL / AX3 / AX5, iPhone portrait (16-26); W22 before/after matrix separately recorded below | **open / pending commit** — the 18-cell Search evidence paths and literal readback limits are recorded below; matched static UI is recorded where available, while dynamic searchable-drawer and live-scroll claims remain untested |
...
Of the eight Favorites/Watched calibration cells, the two recorded Favorites out cells remain the only user-accepted observations. The remaining six now have control or cold evidence recorded below, but any new pixel difference remains an observation for review and is not accepted or waived. The superseded older Favorites out paths are retained only as history; the accepted observation uses the matched pairs `calibration-v3b/before/favorites-out-large-1.png` ↔ `calibration-v3b/after/favorites-out-large-1.png` and `calibration-v3b/before/favorites-out-ax5-1.png` ↔ `calibration-v3b/after/favorites-out-ax5-1.png`, with same-version 1-vs-2 captures producing zero ROI differences at both sizes. These are two accepted cells only: native `1206x2622`, ROI `[0,330,1206,2622]`, large had 325105 nonzero differences with maximum RGB delta 3, and AX5 had 89381 with maximum RGB delta 8. The user's acceptance records these observed differences as acceptable for these two cells; it does not establish natural-system noise, a general tolerance, or W-22 completion.
...
| Favorites in / `.large` | `calibration-v4-phone/before/favorites-in-large/screen.png`, `ui.json`, `prelaunch-readback.log` | `calibration-v4-phone/after/favorites-in-large/screen.png`, `ui.json`, `prelaunch-readback.log` | cold cross-version 0 / max 0 in native ROI `[0,330,1206,2622]`; no same-version control captured; observed, not accepted |
| Favorites in / AX5 | `calibration-v4-controls/before/favorites-in-ax5/root-control-2.png`, `root-control-ui.json`, `root-control-readback.log` | `calibration-v4-controls/after/favorites-in-ax5/root-control-2.png`, `root-control-ui.json`, `root-control-readback.log` | cold AX5 controls; same-version 0 / max 0; cross-version 0 / max 0 in native ROI; observed, not accepted |
| Watched out / `.large` | `calibration-v4-controls/watched-out-large/before/screen-2.png`, `screen-1.png` and corresponding UI/readback | `calibration-v4-controls/watched-out-large/after/screen-2.png`, `screen-1.png` and corresponding UI/readback | same-version controls 0 / max 0; cross-version title-masked 187921 / max 38; body ROI 868 / max 5; tabbar ROI 187053 / max 38; observed FAIL/PENDING, not accepted |
| Watched out / AX5 | `calibration-v4-phone-reload/before/watched-out-ax5/root-control-2.png`, `root-control-ui.json`, `root-control-readback.log` | `calibration-v4-phone-reload/after/watched-out-ax5/root-control-2.png`, `root-control-ui.json`, `root-control-readback.log` | supplemental live `.large` → AX5 controls; same-version and cross-version controls 0 / max 0 in native ROI; original cold comparison remains below; observed, not accepted |
| Watched in / `.large` | `calibration-v4-phone-reload/before/watched-in-large/screen.png`, `ui.json`, `prelaunch-readback.log` | `calibration-v4-phone-reload/after/watched-in-large/screen.png`, `ui.json`, `prelaunch-readback.log` | cold pair 0 / max 0 in native ROI; observed, not accepted |
| Watched in / AX5 | `calibration-v4-phone-reload/before/watched-in-ax5/root-control-2.png`, `root-control-ui.json`, `root-control-readback.log` | `calibration-v4-phone-reload/after/watched-in-ax5/root-control-2.png`, `root-control-ui.json`, `root-control-readback.log` | supplemental live `.large` → AX5 controls; same-version 0 / max 0; cross-version 2022 / max 21, bbox `(121,2092,297,2217)`; original cold comparison remains below; observed FAIL/PENDING, not accepted |
...
| Favorites in / AX5 | `calibration-v4-phone/before/favorites-in-ax5/screen.png` → `calibration-v4-phone/after/favorites-in-ax5/screen.png` | `792 changed / max 2`, ROI `[0,330,1206,2622]` |
