...
- D-25 evidence is under $HOME/Library/Caches/ehpanda-phase16/resweep/20260917-final/; Search #9, Favorites #8, and Watched #5 each have XXL/AX3/AX5 coverage (9 cells, 8 pass plus the Favorites AX5 finding). The owner accepted #39 as an Apple native-search bug with no app fix requested.
...
- Owner gates remain manual: phonetic judgment on the revised W-33 audio and final sign-off; W-34 MiB pronunciation is accepted within scope.
