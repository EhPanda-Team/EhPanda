...
Per section — Initialization & configuration 10/15, Signal emission 1/7, Duration signals 0/3, Error signals 2/3, Navigation signals 0/4, Purchase & preset APIs 0/9, Legacy & interop 1/4 (INTEGRATE/OPT-OUT).
