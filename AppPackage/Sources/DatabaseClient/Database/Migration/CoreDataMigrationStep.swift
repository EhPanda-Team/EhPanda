...
public struct CoreDataMigrationStep {
    ...
    public init(sourceVersion: CoreDataMigrationVersion, destinationVersion: CoreDataMigrationVersion) throws {
    ...
    private static func customMappingModel(
        ...
        NSMappingModel(from: [Bundle.module], forSourceModel: sourceModel, destinationModel: destinationModel)
    }
}
