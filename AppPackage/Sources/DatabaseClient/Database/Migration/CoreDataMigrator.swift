...
public final class CoreDataMigrator: CoreDataMigratorProtocol, Sendable {
    public func requiresMigration(at storeURL: URL, toVersion version: CoreDataMigrationVersion) throws -> Bool {
    ...
    public func migrateStore(at storeURL: URL, toVersion version: CoreDataMigrationVersion) throws {
        ...
        for migrationStep in migrationSteps {
            ...
            let destinationURL = URL.temporaryDirectory.appendingPathComponent(UUID().uuidString)
    ...
    public func forceWALCheckpointingForStore(at storeURL: URL) throws {
        guard let metadata = NSPersistentStoreCoordinator.metadata(at: storeURL),
