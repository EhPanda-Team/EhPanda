...
struct GalleryImageURLParserTests: TestHelper {
    ...
    func testGalleryNormalImageURLParser(doc: HTMLDocument) throws {
        let inputIndex = 1
        let result = try Parser.parseGalleryNormalImageURL(doc: doc, index: inputIndex)
        let index = result.index
        let imageURL = result.imageURL
        let originalImageURL = result.originalImageURL
        #expect(index == inputIndex)
        let expectedImageURL =
            "https://akrtazd.spuqplybaxmf.hath.network:65000/h/"
            + "ea42b28bceeae68f1f6adb414da61d186b3d126b-311480-1280-1920-jpg/"
            + "keystamp=1694132700-fd778f8260;fileindex=132044713;xres=1280/"
            + "87052610_5090394_0.jpg"
        #expect(imageURL.absoluteString == expectedImageURL)
